...
class nickname-login_Admin_API {
	...
	public function display_field ( $data = array(), $post = false, $echo = true ) {
		...
		switch( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image' , 'nickname-login' ) . '" data-uploader_button_text="' . __( 'Use image' , 'nickname-login' ) . '" class="image_upload_button button" value="'. __( 'Upload new image' , 'nickname-login' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="'. __( 'Remove image' , 'nickname-login' ) . '" />' . "\n";
